...
WIDGET_BG_COLOR = (255, 255, 255, 180); WIDGET_BG_RADIUS = 10
...
try:
    ...
    FONT_CACHE = {
        ...
        'bold_12': ImageFont.truetype(DEFAULT_BOLD_FONT_PATH, 12),
...
def draw_summary_image(data: SummaryDrawData, loader: LocalAssetLoader) -> Image.Image:
    ...
    if hasattr(data, 'visited_characters') and data.visited_characters:
        ...
        if hasattr(data, 'gate_level'):
            draw.text((panel_x_start + 32 + 32, panel_y_cursor + 82), f"Lv.{data.gate_level}", font=FONT_CACHE['bold_12'], fill=BLACK, anchor="ms")
